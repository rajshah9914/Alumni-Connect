...
if(isset($_GET["u"])){
    ...
    header("location: http://localhost/ST3Project/");
    exit();	
}
...
//   $us2=$row["username"];
//   $friend_check = "SELECT user2 from friends where user1!='Admin' and user2=='$us2' and activated=='0'";
//   $query_for_friend_check=mysqli_query($db_conx,$friend_check);
//   $usernum=mysqli_num_rows($query_for_friend_check);
//   echo $usernum;
// }
...
while($row=mysqli_fetch_array($query,MYSQLI_ASSOC)){
  $us=$row["username"];
  $friend_making = "INSERT INTO friends(user1,user2,accepted) VALUES ('$adm','$us','1')";
  $query_for_friend_request=mysqli_query($db_conx,$friend_making);
//   if($query_for_friend_request)
//   echo "Data inserted";
}
//-----------------
if($u==='admin')
...
if($friend_count < 1){
	...
	// Separate all users in array by Or
	$orLogic = '';
...
<div id="pageMiddle">
  ...
  <!-- &lt;script&gt; -->
  <h2><?php echo $u; ?></h2>
  <p>Viewer Logged in and Verified? <b><?php echo $isOwner; ?></b></p>
  <p><b>Gender:</b> <?php echo $sex; ?></p>
  <p><b>Branch/ Department:</b> <?php echo $branch; ?></p>
  <p><b>Graduation Date:</b> <?php echo $batch; ?></p>
  <p><b>Country:</b> <?php echo $country; ?></p>
  <p><b>Join Date:</b> <?php echo $joindate; ?></p>
  <p><b>Last Session:</b> <?php echo $lastsession; ?></p>
  <hr />
  <p><b>Friend Button:</b> <span id="friendBtn"><?php echo $friend_button; ?></span> <?php echo $u." has ".$friend_count." friends"; ?> <?php echo $friends_view_all_link; ?></p>
  <p><b>Block Button:</b> <span id="blockBtn"><?php echo $block_button; ?></span></p>
  <hr />
