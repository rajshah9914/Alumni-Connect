...
$notification_list = "";    //case sensitive comparisons..
...
if($numrows < 1){
	...
	while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
		$noteid = $row["id"];
		$initiator = $row["initiator"];  //Who posted?? 
		$app = $row["app"];         //Type of post:- status post,comment..
		$note = $row["note"];      //Where posted..profile or conversations..
